...
Если совсем просто: Eidra — это фильтр безопасности для ИИ-инструментов. Он смотрит, что ваши инструменты собираются отправить или выполнить, и помогает скрыть, остановить или оставить локально рискованные части.
...
- Для самого простого объяснения: [For Everyone](for-everyone.md)
- Для конкретных примеров: [Use Cases](use-cases.md)
- Для самых свежих технических деталей: [английский README](../README.md) и [For Developers](for-developers.md)
