<p align="center">
  ...
  <p align="center">
    ...
    <a href="README.zh.md"><kbd><strong>简体中文</strong></kbd></a>
...
用最直白的话说：Eidra 就是 AI 工具前面的安全过滤器。它会看这些工具准备发送什么、准备做什么，然后帮助你把危险部分隐藏、拦下，或者留在本地处理。
...
- 想先看最简单的解释：读 [For Everyone](for-everyone.md)
- 想看具体例子：读 [Use Cases](use-cases.md)
- 想看最新技术细节：读 [英文 README](../README.md) 和 [For Developers](for-developers.md)
