...
쉽게 말하면, Eidra는 AI 도구를 위한 안전 필터입니다. AI가 무엇을 보내거나 실행하려는지 보고, 위험한 부분을 숨기거나 막거나 로컬에 남기도록 도와줍니다.
...
- 가장 쉬운 설명부터 보려면: [For Everyone](for-everyone.md)
- 구체적인 예시를 보려면: [Use Cases](use-cases.md)
- 최신 기술 설명을 보려면: [영문 README](../README.md) 와 [For Developers](for-developers.md)
